...
INSERT INTO `content` (`id`, `protection_system_id`, `content_key`, `payload`) VALUES (1, 2, 'superpass', 'U2FsdGVkX190cOearjAhFozvAQFjW53OUhLQGKfTVZnj8iOwveiaZ8rqAPNBjeDB'), (2, 1, 'mypassword', 'U2FsdGVkX1+lxfHPBsyNB+R1lJ2qOz/uA7NTprwWXhaMaQLNyhPRCyUq13VvkRDp'), (3, 2, 'badpass', 'U2FsdGVkX1+lxfJ2qOz/uA7NTprwWXhaMaQLNHPBsyNB+R1lyhPRCyUq13VvkRDp');
